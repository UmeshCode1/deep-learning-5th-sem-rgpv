          ...
          <div className="p-6 max-h-[60vh] overflow-y-auto space-y-6">
                ...
                <div key={category}>
                  ...
                  <div className="space-y-2">
                    {categoryShortcuts.map((shortcut, index) => (
                      ...
                      >
                        <span className="text-slate-900 dark:text-white font-medium group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors">
            ...
            {filteredShortcuts.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">No shortcuts found</h3>
                <p className="text-slate-600 dark:text-gray-400">Try a different search term</p>
              </div>
            )}
          </div>
