    ...
    <section id="learning-timeline" className="scroll-mt-20 perspective-2000">
      ...
      <div className="text-center mb-16">
        <div className="inline-flex items-center gap-4 mb-4">
          <div className="w-16 h-16 bg-gradient-to-br from-emerald-600 to-teal-600 dark:from-emerald-500 dark:to-teal-500 rounded-2xl flex items-center justify-center shadow-2xl animate-float">
            <span className="text-4xl">🗓️</span>
          </div>
          <h2 className="text-6xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 dark:from-emerald-400 dark:via-teal-400 dark:to-cyan-400 animate-gradient tracking-tighter">
            Learning Path
          </h2>
        </div>
      ...
      <div className="relative max-w-5xl mx-auto px-2 sm:px-0">
        ...
        <div className="mt-16 text-center">
          <div className="inline-block glass-dark backdrop-blur-xl rounded-2xl p-8 border border-purple-500/30 shadow-2xl animate-bounce-slow">
